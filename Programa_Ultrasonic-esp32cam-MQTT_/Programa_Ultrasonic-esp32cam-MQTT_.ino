/*
 * lectura del sensor ultrasonico HC-SR04 con el ESP32cam y MQTT
 * por: Daniel Romero
 * Fecha: 1 de octubre  de 2021
 * 
 * Este programa lee el sensor con la biblioteca ultrasonic de Erick Simoes 
 * en la version 3.0.0, se mezcla con el programa ESP32CAM-MQTT-basis del repositorio 
 * del codigo IoT
